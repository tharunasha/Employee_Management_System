...
function CreateEmployee() {
    ...
    const validate = (e)=>{
        ...
        if(!employees.doj)
        {
            formErrors.doj = "Date of join is mandatory";
            isValid=false;
        }
  ...
  return (
    <div className='mt-5'>
        <div className='container pt-3'>
            <div className='card w-50 offset-3 p-3 mt-4'>
                <h5 className='text-center pt-3'>Add Employees</h5>
                <form>
                    <label>Name</label>
                    ...
                    onChange={handleChange}
                    />
                    {errors.deptName && <small className='text-danger'>{errors.name}</small>}
                    <br />
                    ...
                    onChange={handleChange}
                    />
                    {errors.designation && <small className='text-danger'>{errors.name}</small>}
                    <br />
